...
class About(ctk.CTkToplevel):
    def __init__(self, controller, *args, **kwargs):
        ...
        frm_about_main = ctk.CTkFrame(master=self, corner_radius=widget_corner_radius)
        ...
        frm_about_logo = ctk.CTkFrame(master=frm_about_main, corner_radius=widget_corner_radius, fg_color="transparent")
...
class ConnectionMaintenanceDialog(ctk.CTkToplevel):
